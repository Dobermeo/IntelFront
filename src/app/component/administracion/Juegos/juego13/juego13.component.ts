...
@Component({
  selector: 'app-juego13',
  templateUrl: './juego13.component.html',
  styleUrls: ['./juego13.component.css']
})
export class Juego13Component implements OnInit {

  url: string = "https://juego13ie.web.app/";
