...
@Component({
  selector: 'app-juego12',
  templateUrl: './juego12.component.html',
  styleUrls: ['./juego12.component.css']
})
export class Juego12Component implements OnInit {

  url: string = "https://juego12ie.web.app/";
